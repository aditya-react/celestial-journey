...
const FeaturedHolidayRentals = () => {
  ...
  <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
    <h2 className="text-3xl font-bold text-gray-900">Featured Holiday Rentals</h2>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-10">
      ...
      <div className="bg-white shadow-lg rounded-lg overflow-hidden group">
        <div className="relative">
          <img src="https://gotrip-appdir.vercel.app/_next/image?url=%2Fimg%2Frentals%2F1.png&w=384&q=75" alt="Hotel 1" className="w-full h-48 object-cover"/>
      ...
      <div className="bg-white shadow-lg rounded-lg overflow-hidden group">
        <div className="relative">
          <img src="https://gotrip-appdir.vercel.app/_next/image?url=%2Fimg%2Frentals%2F2.png&w=384&q=75" alt="Hotel 2" className="w-full h-48 object-cover"/>
          <button className="absolute top-2 right-2 bg-white p-2 rounded-full shadow text-gray-700 hover:text-red-500">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
              <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 3.75a6 6 0 00-9 7.5l9 9 9-9a6 6 0 00-9-7.5z" />
            </svg>
      ...
      <div className="bg-white shadow-lg rounded-lg overflow-hidden group">
        <div className="relative">
          <img src="https://gotrip-appdir.vercel.app/_next/image?url=%2Fimg%2Frentals%2F3.png&w=384&q=75" alt="Hotel 3" className="w-full h-48 object-cover"/>
      ...
      <div className="bg-white shadow-lg rounded-lg overflow-hidden group">
        <div className="relative">
          <img src="https://gotrip-appdir.vercel.app/_next/image?url=%2Fimg%2Frentals%2F4.png&w=384&q=75" alt="Hotel 4" className="w-full h-48 object-cover"/>
